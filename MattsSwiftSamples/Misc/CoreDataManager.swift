...
class CoreDataManager {
    ...
    class func fetch<T:NSManagedObject>(_ t:T.Type, inContext context:NSManagedObjectContext=CoreDataManager.mainContext(), withPredicate predicate:Predicate?=nil, andSortDescriptors sortDescriptors:[SortDescriptor]?=nil, fetchLimit:Int?=nil) -> [T] {
